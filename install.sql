...
(1, 'full', 'Standard Redactor-Konfiguration', 'relative', 'alignment,bold,deleted,horizontalrule,html,italic,link,orderedlist,underline,unorderedlist', 'cleaner,clips[Snippetname1=Snippettext1|Snippetname2=Snippettext2],fontcolor[Weiss=#ffffff|Schwarz=#000000],fontfamily[Arial|Times],fontsize[12px|15pt|120%],fullscreen,heading1,heading2,heading3,heading4,heading5,heading6,paragraph,rex_linkmap,rex_mediapool_image,rex_mediapool_link,table,textdirection,video');
