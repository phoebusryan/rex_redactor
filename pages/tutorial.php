<?php
	...
	$moduleInput .= '    <label class="col-sm-2 control-label" for="redactor_1">VALUE 1</label>'.PHP_EOL;
	$moduleInput .= '    <div class="col-sm-10">'.PHP_EOL;
	$moduleInput .= '      <textarea cols="1" rows="6" class="form-control redactorEditor-full" id="redactor_1" name="REX_INPUT_VALUE[1]">REX_VALUE[1]</textarea>'.PHP_EOL;
