<?php
	...
	//Start - configuration form
		...
		//Start - add custom_css field
			$n = [];
			$n['label'] = '<label for="rex-form-custom_js">' . 'Custom JS' . '</label>';
			$n['field'] = '<textarea class="form-control" id="rex-form-custom_js" name="custom_js">'.$config['custom_js'].'</textarea>';
			$formElements[] = $n;
